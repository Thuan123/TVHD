...
public class ImageEpisodePageAdapter extends PagerAdapter {
	...
	public ImageEpisodePageAdapter(Activity ac, Context context,List<Episode> epiList) {
		mContext = context;
		this.ac = ac;
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		filmName.setText(epiList.get(position).getName());
		if(epiList.get(position).getLogoUrl()!=null){
			ImageLoader.getInstance().displayImage(epiList.get(position).getLogoUrl().toString(), imageView, options, new SimpleImageLoadingListener() {
				@Override
