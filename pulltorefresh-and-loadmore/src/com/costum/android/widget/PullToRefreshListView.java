...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	// header
	private RelativeLayout mRefreshView, layout;
	...
	protected void init(Context context) {
		...
		layout = (RelativeLayout) mRefreshView
				.findViewById(R.id.pull_to_refresh_header);
		// layout.setClickable(false);
		// mRefreshView.setClickable(false);
		// mRefreshViewText.setClickable(false);
		// mRefreshViewImage.setClickable(false);
		// mRefreshViewProgress.setClickable(false);
		// mRefreshViewLastUpdate.setClickable(false);
